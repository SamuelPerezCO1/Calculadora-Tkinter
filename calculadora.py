...
class Calculadora(tk.Tk):
    ...
    def _creacion_componentes(self):
        ...
        entrada_frame = tk.Frame(self, width=350,height=50,bg='grey')
        ...
        boton_siete = tk.Button(botones_frame, text='7', width=10 , height=3, bd=0,
                                bg='#fff', cursor='hand2' , command=lambda:self._evento_click(7))
        ...
        boton_menos = tk.Button(botones_frame , text='-', width=10 , height=3 , bd=0 , bg='#fff',
        ...
        boton_mas = tk.Button(botones_frame , text = '+' , width = 10 , height=3 , bd = 0 , bg= '#fff',
                              cursor = 'hand2' , command = lambda:self._evento_click('+'))
        ...
        boton_evaluar = tk.Button(botones_frame , text='=' , width= 10 , height = 3 , bd = 0 , bg = '#fff' ,
                                cursor = 'hand2' , command= self._evento_evaluar)
        boton_evaluar.grid(row=4 , column= 3 , padx=1 , pady=1)
        
    def _evento_evaluar(self):
        #Eval evaluar la expresion str como una expresion aritmetica
